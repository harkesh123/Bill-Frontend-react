...
class Suggestion extends React.Component {
  ...
  onClick = () => {
    ...
    const t = vlist.filter(lang => lang.product_name === this.state.value);
    this.state.blist.push(t[0]);
    this.state.bunit.push(this.state.unit);
    var cost =
      t[0].product_price * this.state.unit +
      t[0].product_price * this.state.unit * (t[0].product_gst / 100);
      ...
      <div>
        <div className="overflow-auto">
          <table className="f6 w-100 mw7 center" cellSpacing="0">
            ...
            <tbody className="lh-copy">
              {this.state.blist.map((d, i) => {
                return (
                  <tr className="stripe-dark" key={this.state.list._id}>
                    <td className="ph5 pv2">
                      {this.state.blist[i].product_code}
                    </td>
                    <td className="ph5 pv2">
                      {this.state.blist[i].product_name}
                    </td>
                    <td className="ph5 pv2">
                      {this.state.blist[i].product_price}
                    </td>
                    <td className="ph5 pv2">{this.state.bunit[i]}</td>
                    <td className="ph5 pv2">
                      {this.state.blist[i].product_gst}
                    </td>
        ...
        <div className="pl7">
          <input
            ...
            placeholder="units"
            onChange={this.onNumb}
            min="1"
          />
          <a
            className="f6 link dim br2 ph3 pv2 mb2 dib white bg-mid-gray"
